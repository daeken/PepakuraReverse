...
def parse(data, file_name: str):
    ...
    if locked == 5:
        print("software:", buf.wstr)  # Empty for en-us
        buf.key = buf.uint32
        print("key:", buf.key)
        print
    ...
    for i in range(buf.uint32):
        ...
        for j in range(buf.uint32):
            ...
            print("        unk12:", arr(buf.double, buf.double, buf.double, buf.double))
            print("        points:")
    ...
    print(
        "unk46:",
        arr(buf.uint32, buf.bool, buf.uint32, buf.uint32, buf.uint32, buf.uint32),
    )
    ...
    print(
        "unk50:",
        arr(buf.double, buf.double, buf.double, buf.double, buf.double, buf.double),
    )
    print(
        "unk51:",
        arr(buf.double, buf.double, buf.double, buf.double, buf.double, buf.double),
